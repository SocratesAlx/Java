 ...
 * @author koute
 */
public class AddSalaryHistory extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
              ...
              String st  = "INSERT INTO salary_history (afm , Salary , effective_date ) VALUES (" +
                            "'"+ afm_selected  +"'," + 
                             " '"+ this.ln.getText()  +"',"+
                         " '"+ this.mn.getText()  +"'"+
                            ");";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddSalaryHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AddSalaryHistory().setVisible(true);
            }
        });
    }
