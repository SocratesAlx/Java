 ...
 */
package ergasiaproodou.guis.view.absence;
...
public class AddAbsence extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String st  = "INSERT INTO absence_history (afm , start_date , end_date) VALUES (" +
            "'"+  afm_selected   +"'," +
            " '"+ this.Email.getText()  +"',"+
            "'"+  this.Email1.getText()   +"'" +
